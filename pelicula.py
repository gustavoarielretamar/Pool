...
archivo="trayectoria.txt" # nombre del archivo a leer
FRAMERATE = 50  # cuadros por segundo (velocidad con que se muestra la pelicula)
...
h=1.0 # Tamaño de la sangría de la caja
...
coor=open(archivo,"trayectorias_muchas_bolas") # nombre del archivo a leer
pygame.init()
...
pygame.display.set_caption(" Animación ") # mensaje en la ventanita
